...
async function main() {
  ...
  await runCommand('node', ['service_sugar'], '\n========= Proses Input File Data =========', 5000);
  await runCommand('node', ['service_sugar_loaddata'], '\n========= Proses service_sugar_loaddata =========', 5000);
  await runCommand('node', ['service_sugar_input'], '\n========= Proses service_sugar_input =========', 5000);
