...
async function main() {
  ...
  const sqltif = `
    ...
    UNION ALL
    SELECT 'ASR-WHF-Assurance Guarantee' AS kpi, sc_lokasi.witel AS lokasi, wsa_sugar.lokasi AS Area, wsa_sugar.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_sugar ON sc_lokasi.witel = wsa_sugar.witel AND wsa_sugar.tgl = '2026-02-13' AND wsa_sugar.lokasi IN ('tif') WHERE sc_lokasi.reg IN ('tif') AND sc_lokasi.witel = 'TERRITORY 03'
    UNION ALL
    SELECT 'ASR-WHF-TTR Comply 3H (D.V)' AS kpi, sc_lokasi.witel AS lokasi, wsa_ttr3.lokasi AS Area, wsa_ttr3.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_ttr3 ON sc_lokasi.witel = wsa_ttr3.witel AND wsa_ttr3.tgl = '2026-02-13' AND wsa_ttr3.lokasi IN ('tif') WHERE sc_lokasi.reg IN ('tif') AND sc_lokasi.witel = 'TERRITORY 03'
    UNION ALL
    SELECT 'ASR-WHF-TTR Comply 6H (P)' AS kpi, sc_lokasi.witel AS lokasi, wsa_ttr6.lokasi AS Area, wsa_ttr6.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_ttr6 ON sc_lokasi.witel = wsa_ttr6.witel AND wsa_ttr6.tgl = '2026-02-13' AND wsa_ttr6.lokasi IN ('tif') WHERE sc_lokasi.reg IN ('tif') AND sc_lokasi.witel = 'TERRITORY 03'
    UNION ALL
    SELECT 'ASR-WHF-TTR Comply 36H (Non HVC)' AS kpi, sc_lokasi.witel AS lokasi, wsa_ttr36.lokasi AS Area, wsa_ttr36.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_ttr36 ON sc_lokasi.witel = wsa_ttr36.witel AND wsa_ttr36.tgl = '2026-02-13' AND wsa_ttr36.lokasi IN ('tif') WHERE sc_lokasi.reg IN ('tif') AND sc_lokasi.witel = 'TERRITORY 03'
    UNION ALL
    SELECT 'ASR-WHF-TTR Comply 3H Manja' AS kpi, sc_lokasi.witel AS lokasi, wsa_ttrmanja.lokasi AS Area, wsa_ttrmanja.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_ttrmanja ON sc_lokasi.witel = wsa_ttrmanja.witel AND wsa_ttrmanja.tgl = '2026-02-13' AND wsa_ttrmanja.lokasi IN ('tif') WHERE sc_lokasi.reg IN ('tif') AND sc_lokasi.witel = 'TERRITORY 03'
    UNION ALL
    ...
    UNION ALL
    SELECT 'ASR-WHF-Service Availability' AS kpi, sc_lokasi.witel AS lokasi, wsa_service.lokasi AS Area, wsa_service.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_service ON sc_lokasi.witel = wsa_service.witel AND wsa_service.tgl = '2026-02-13' AND wsa_service.lokasi IN ('tif') WHERE sc_lokasi.reg IN ('tif') AND sc_lokasi.witel = 'TERRITORY 03'
    UNION ALL
  ...
  const sqlccm = `
      ...
      UNION ALL
      SELECT 'ASR-WHF-Assurance Guarantee' AS kpi, sc_lokasi.witel AS lokasi, wsa_sugar.lokasi AS Area, wsa_sugar.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_sugar ON sc_lokasi.witel = wsa_sugar.witel AND wsa_sugar.tgl = '2026-02-13' AND wsa_sugar.lokasi IN ('area_ccm', 'balnus_ccm', 'jateng_ccm', 'jatim_ccm') WHERE sc_lokasi.reg IN ('area_ccm', 'balnus_ccm', 'jateng_ccm', 'jatim_ccm') AND wsa_sugar.${bln} IS NOT NULL
      UNION ALL
      SELECT 'ASR-WHF-TTR Comply 3H (D.V)' AS kpi, sc_lokasi.witel AS lokasi, wsa_ttr3.lokasi AS Area, wsa_ttr3.${bln} AS Realisasi FROM sc_lokasi LEFT JOIN wsa_ttr3 ON sc_lokasi.witel = wsa_ttr3.witel AND wsa_ttr3.tgl = '2026-02-13' AND wsa_ttr3.lokasi IN ('area_ccm', 'balnus_ccm', 'jateng_ccm', 'jatim_ccm') WHERE sc_lokasi.reg IN ('area_ccm', 'balnus_ccm', 'jateng_ccm', 'jatim_ccm') AND wsa_ttr3.${bln} IS NOT NULL
      UNION ALL
