...
async function main() {
  ...
  await runCommand('node', ['assurance_ebis'], '\n========= Proses Scrapp Data Assurance EBIS via Bot =========', 5000);
  await runCommand('node', ['assurance_ebis_input'], '\n========= Proses Input Data EBIS =========', 5000);
  await runCommand('node', ['assurance_ebis_input_datin'], '\n========= Proses Input Data EBIS =========', 5000);
  await runCommand('node', ['assurance_ebis_input_hsi'], '\n========= Proses Input Data EBIS =========', 5000);
