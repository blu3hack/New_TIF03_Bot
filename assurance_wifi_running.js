...
async function main() {
  ...
  await runCommand('node', ['assurance_wifi'], '\n========= Proses Scrapp Data Assurance WIFI via Bot =========', 5000);
  await runCommand('node', ['assurance_wifi_input'], '\n========= Proses Input Data WIFI =========', 5000);
