...
(async () => {
  ...
  try {
    ...
    /* ===============================
       DOWNLOAD FILES (AMAN)
    =============================== */
    await download('https://telkomcare.telkom.co.id/assurance/lapebis25/detailrescomp25?read=all&param_teritory=&tahun=&bulan=&sumber=DATIN24&tiket=&startdate=&enddate=&custpending=&regional=REG-4&kategori=&tcomp=', 'REG-4_TTR_DATIN');
    await delay(20000);
    await download('https://telkomcare.telkom.co.id/assurance/lapebis25/detailrescomp25?read=all&param_teritory=&tahun=&bulan=&sumber=DATIN24&tiket=&startdate=&enddate=&custpending=&regional=REG-5&kategori=&tcomp', 'REG-5_DATIN');
    await delay(20000);
    await download('https://telkomcare.telkom.co.id/assurance/lapebis25/detailsugar25?read=all&param_teritory=TELKOMLAMA&enddate=2026-01-28&tahun=&bulan=&sumber=DATIN24&tiket=&regional=REG-4&kategori=bukan_gaul', 'REG-4_BUKAN_GAUL');
    await delay(20000);
    await download('https://telkomcare.telkom.co.id/assurance/lapebis25/detailsugar25?read=all&param_teritory=TELKOMLAMA&enddate=2026-01-28&tahun=&bulan=&sumber=DATIN24&tiket=&regional=REG-4&kategori=grand_total', 'REG-4_GRAND_TOTAL');
    await delay(20000);
  } catch (err) {
